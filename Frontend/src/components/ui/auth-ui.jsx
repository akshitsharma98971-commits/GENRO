...
function SignInForm() {
  const handleSignIn = (event) => { event.preventDefault(); console.log("UI: Sign In form submitted"); };
  return (
...
function SignUpForm() {
  const handleSignUp = (event) => { event.preventDefault(); console.log("UI: Sign Up form submitted"); };
  return (
...
export function AuthUI({ signInContent = {}, signUpContent = {} }) {
  ...
  return (
    <div className="w-full min-h-screen md:grid md:grid-cols-2">
      ...
      <div
        className="hidden md:block relative bg-contain bg-no-repeat bg-center transition-all duration-500 ease-in-out"
